...
import ch.css.community.alfons.data.db.tables.Configuration;
...
interface ConfigurationService extends DSLContextGetter {
    ...
    default ch.css.community.alfons.configuration.Configuration loadConfigurationFromDatabase() {
        ...
        return new ch.css.community.alfons.configuration.Configuration(Collections.unmodifiableMap(configurationData));
    }
