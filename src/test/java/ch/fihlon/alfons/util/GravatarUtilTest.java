...
public class GravatarUtilTest {
    ...
    void getGravatarAddressWithoutSize() {
        final var address = GravatarUtil.getGravatarAddress("marcus@fihlon.swiss");
        assertEquals("https://www.gravatar.com/avatar/b7fd700b1ed81ebff879cdd72ed4a2a4?d=mp&s=80", address);
    }

    @Test
    void getGravatarAddressWithSize100() {
        final var address = GravatarUtil.getGravatarAddress("marcus@fihlon.swiss", 100);
        assertEquals("https://www.gravatar.com/avatar/b7fd700b1ed81ebff879cdd72ed4a2a4?d=mp&s=100", address);
    }

    @Test
    void getGravatarAddressWithInvalidSize() {
        final var tooSmall = assertThrows(IllegalArgumentException.class,
                () -> GravatarUtil.getGravatarAddress("marcus@fihlon.swiss", 0));
        ...
        final var tooBig = assertThrows(IllegalArgumentException.class,
                () -> GravatarUtil.getGravatarAddress("marcus@fihlon.swiss", 2049));
