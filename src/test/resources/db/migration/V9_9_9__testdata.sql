...
INSERT INTO request (employee_id, conference_id, request_date, role, reason, status, status_date, status_comment) VALUES (1, 1, '2023-01-01 12:00:00', 'attendee', 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.', 'submitted', '2023-01-01 12:00:00', '');
INSERT INTO request (employee_id, conference_id, request_date, role, reason, status, status_date, status_comment) VALUES (2, 1, '2023-01-02 12:00:00', 'attendee', 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.', 'submitted', '2023-01-01 12:00:00', '');
